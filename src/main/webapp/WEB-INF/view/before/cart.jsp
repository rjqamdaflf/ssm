    ...
    <div>
        <div class="nFlowBox">
            <table width="99%" align="center" border="0" cellpadding="5"
                ...
                <!-- 这里使用了jstl标签-->
                <c:forEach var="ce" items="${date.cartlist}">
                    <tr>
                        <td bgcolor="#ffffff" align="center"><a href="goodsDetail?id=${ce.goods.id}"> <img
                                style="width: 100px; height: 100px;"
                                src="logos/${ce.goods.gpicture}" border="0"
                                title="${ce.goods.gname}"/>
                        </a><br/><a style="text-decoration: none;" href="goodsDetail?id=${ce.goods.id}"
                                    class="f6">${ce.goods.gname}</a></td>
                        <td bgcolor="#ffffff" width="110px" align="center"><span>${ce.goods.grprice}</span></td>
                        <td align="center" bgcolor="#ffffff" width="115px"
                            valign="middle"><input type="text" name="goods_number"
                                                   value="${ce.cart.shoppingnum}" size="4"
                                                   class="inputBg"
                        ...
                        <td align="center" bgcolor="#ffffff" width="185px"><a
                                style="text-decoration: none;" href="javaScript:deleteAgoods('${ce.goods.id}')"
