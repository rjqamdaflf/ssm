...
<div class="block clearfix"><!--当前位置-->
    <div class="location ared">当前位置：<a href="/before">首页</a> > 购物流程 > 确认订单信息</div>
    <div class="blank"></div>
    <div class="nFlowBox">
            ...
            <table width="100%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
                ...
                <c:forEach var="ce" items="${date.cartlist}">
                    <tr>
                        ...
                        <td align="center" bgcolor="#ffffff">${ce.goods.grprice}</td>
                ...
                <tr>
                    <td bgcolor="#ffffff" colspan="4" align="right">
                        应付款
                        <font class="pricetype" size="5" color="red">￥&nbsp;${date.total}&nbsp;元</font>
                    </td>
                </tr>
            </table>
            <div align="center" style="margin:8px auto;">
                <img style="cursor:pointer;" onclick="submitorder(${date.total})" src="images/before/bnt_subOrder.gif"/>
            </div>
