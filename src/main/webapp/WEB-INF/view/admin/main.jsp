...
<div id="navigator">
    <ul>
        <li><a href="adminGoods/selectGoods" target="center">商品管理</a>
            <ul>
                <li><a href="adminGoods/toAddGoods" target="center">添加商品</a></li>
            </ul>
        </li>
        <li><a href="adminType/getAllType" target="center">类型管理</a>
            <ul>
                <li><a href="adminType/toAddType" target="center">添加类型</a></li>
            </ul>
        </li>
        <li><a href="adminNotice/selectAllNotice" target="center">公告管理</a>
            <ul>
                <li><a href="adminNotice/toAddNotice" target="center">添加公告</a></li>
            </ul>
        </li>
        <li><a href="adminUser/userInfo" target="center">用户管理</a></li>
        <li><a href="adminOrder/orderInfo" target="center">订单管理</a></li>
